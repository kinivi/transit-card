...
`;function $t(t){return t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit",hour12:!1})}let bt=class extends at{constructor(){super(...arguments),this.now=new Date}render(){const t=this.departure,e=function(t,e=new Date){const s=t.getTime()-e.getTime();return Math.floor(s/6e4)}(t.actualTime||t.plannedTime,this.now),s=e<=5&&e>=0;return q`
    ...
    `],t([pt()],wt.prototype,"type",void 0),t([pt({type:Boolean})],wt.prototype,"collapsed",void 0),t([pt({attribute:!1})],wt.prototype,"departures",void 0),t([pt({attribute:!1})],wt.prototype,"now",void 0),t([pt({type:Number})],wt.prototype,"maxItems",void 0),wt=t([ct("transit-section")],wt);let xt=class extends at{constructor(){super(...arguments),this.status="loading",this.lastUpdated=null}_getStatusText(){switch(this.status){case"live":return"Live";case"loading":return"Aktualisiere...";case"error":return"Fehler";case"offline":return"Offline"}}render(){return q`
    ...
    `}static getConfigElement(){}static getStubConfig(){return{type:"custom:transit-card",title:"Abfahrten",stops:{sbahn:"",tram:"",bus:""},refresh_interval:30,max_departures:5}}};At.styles=vt,t([pt({attribute:!1})],At.prototype,"hass",void 0),t([ut()],At.prototype,"_config",void 0),t([ut()],At.prototype,"_departures",void 0),t([ut()],At.prototype,"_status",void 0),t([ut()],At.prototype,"_lastUpdated",void 0),t([ut()],At.prototype,"_now",void 0),t([ut()],At.prototype,"_collapsedSections",void 0),t([ut()],At.prototype,"_error",void 0),At=t([ct("transit-card")],At),window.customCards=window.customCards||[],window.customCards.push({type:"transit-card",name:"Transit Card",description:"Real-time transit departures with glass-blur aesthetic",preview:!0,documentationURL:"https://github.com/kinivi/transit-card"});export{At as TransitCard};
